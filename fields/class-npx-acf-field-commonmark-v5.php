...
if( !class_exists('npx_acf_field_commonmark') ) :


class npx_acf_field_commonmark extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('CommonMark', 'acf-commonmark');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-commonmark'),
		}
...
// initialize
new npx_acf_field_commonmark( $this->settings );
